...
import dev.vale.metal.{FunctionH, Local, NeverH, PureH, UserFunctionH, VariableIdH}
import dev.vale.templar.Hinputs
import dev.vale.templar.ast.{ExternT, FunctionHeaderT, FunctionT, IFunctionAttributeT, PrototypeT, PureT, UserFunctionT}
