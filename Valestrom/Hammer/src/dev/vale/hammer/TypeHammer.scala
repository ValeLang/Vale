...
import dev.vale.metal.{BoolH, FloatH, InlineH, IntH, KindH, NeverH, PrototypeH, ReferenceH, RuntimeSizedArrayDefinitionHT, RuntimeSizedArrayHT, StaticSizedArrayDefinitionHT, StaticSizedArrayHT, StrH, VoidH, YonderH}
import dev.vale.templar.Hinputs
import dev.vale.templar.ast.PrototypeT
import dev.vale.templar.types.{BoolT, BorrowT, CoordT, FloatT, IntT, InterfaceTT, KindT, NeverT, OverloadSetT, OwnT, RuntimeSizedArrayTT, ShareT, StaticSizedArrayTT, StrT, StructTT, VoidT, WeakT}
...
//import dev.vale.templar.templata.FunctionHeaderT
