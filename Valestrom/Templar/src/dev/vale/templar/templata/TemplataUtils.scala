...
import dev.vale.templar.ast.{FunctionHeaderT, FunctionT, PrototypeT}
import dev.vale.templar.names.{CitizenNameT, CitizenTemplateNameT, ClosureParamNameT, CodeVarNameT, FreeNameT, FullNameT, FunctionNameT, INameT, ImplDeclareNameT, LambdaCitizenNameT, LetNameT, MagicParamNameT, UnnamedLocalNameT}
