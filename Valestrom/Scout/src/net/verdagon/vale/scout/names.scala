...
import net.verdagon.vale.{CodeLocationS, IInterning, Interner, PackageCoordinate, RangeS, vassert, vcheck, vcurious, vimpl, vpass, vwat}
...
case class SelfPermissionRuneS() extends IRuneS {  }
