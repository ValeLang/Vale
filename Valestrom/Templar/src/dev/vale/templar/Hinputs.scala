...
import dev.vale.templar.ast.{EdgeT, FunctionExportT, FunctionExternT, FunctionT, InterfaceEdgeBlueprint, KindExportT, KindExternT, PrototypeT, SignatureT}
import dev.vale.templar.names.{CitizenNameT, CitizenTemplateNameT, FullNameT, FunctionNameT, IFunctionNameT, LambdaCitizenNameT}
import dev.vale.templar.templata.simpleName
import dev.vale.templar.types.{InterfaceDefinitionT, InterfaceTT, KindT, StructDefinitionT, StructTT}
