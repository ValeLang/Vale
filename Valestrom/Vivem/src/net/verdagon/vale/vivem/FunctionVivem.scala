...
//    heap.vivemDout.println("/Function")
  ...
  def getExternFunction(programH: ProgramH, ref: PrototypeH): (AdapterForExterns, Vector[ReferenceV]) => ReferenceV = {
    ref.fullName.toFullString() match {
      ...
      case """::F("__vale_panic")""" => VivemExterns.panic
      ...
      case """::F("__vbi_vaddStr",[],[R(*,>,#,s),R(*,<,#,i(32)),R(*,<,#,i(32)),R(*,>,#,s),R(*,<,#,i(32)),R(*,<,#,i(32))])""" => VivemExterns.addStrStr
      case """ioutils::F("__vbi_getch")""" => VivemExterns.getch
      ...
      case """::F("__vbi_vprintStr",[],[R(*,>,#,s),R(*,<,#,i(32)),R(*,<,#,i(32))])""" => VivemExterns.print
      case """::F("__vbi_not",[],[R(*,<,#,b)])""" => VivemExterns.not
      case """::F("__vbi_castI32Str",[],[R(*,<,#,i(32))])""" => VivemExterns.castI32Str
      case """::F("__vbi_castI32Float",[],[R(*,<,#,i(32))])""" => VivemExterns.castI32Float
      case """::F("__vbi_castFloatI32",[],[R(*,<,#,f)])""" => VivemExterns.castFloatI32
      ...
      case """::F("__vbi_castFloatStr",[],[R(*,<,#,f)])""" => VivemExterns.castFloatStr
