...
import dev.vale.scout.{AbstractBodyS, CodeNameS, CodeRuneS, CodeVarNameS, CoordTemplataType, FreeDeclarationNameS, FunctionTemplataType, ParameterS, SelfNameS, TemplateTemplataType}
...
import dev.vale.templar.names.{FreeTemplateNameT, FullNameT, INameT}
import dev.vale.templar.types.{ImmutableT, MutabilityT}
