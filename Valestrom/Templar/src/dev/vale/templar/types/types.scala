package dev.vale.templar.types

import dev.vale.{IInterning, Interner, PackageCoordinate, vassert, vcurious, vfail, vpass}
import dev.vale.scout.IImpreciseNameS
import dev.vale.templar.ast.{AbstractT, FunctionHeaderT, ICitizenAttributeT}
import dev.vale.templar.env.IEnvironment
import dev.vale.templar.names.{CitizenNameT, FullNameT, ICitizenNameT, IVarNameT, RawArrayNameT, RuntimeSizedArrayNameT, StaticSizedArrayNameT}
