...
case class CallPT(range: Range, template: ITemplexPT, args: List[ITemplexPT]) extends ITemplexPT { override def hashCode(): Int = vcurious() }
...
case class ManualSequencePT(range: Range, elements: List[ITemplexPT]) extends ITemplexPT { override def hashCode(): Int = vcurious() }
...
case class PackPT(range: Range, members: List[ITemplexPT]) extends ITemplexPT { override def hashCode(): Int = vcurious() }
...
case class PrototypePT(range: Range, name: NameP, parameters: List[ITemplexPT], returnType: ITemplexPT) extends ITemplexPT { override def hashCode(): Int = vcurious() }
