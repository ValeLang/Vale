package dev.vale.templar.ast

//import dev.vale.astronomer.IVarNameA
import dev.vale.templar.env.{ILocalVariableT, ReferenceLocalVariableT}
import dev.vale.templar.names.{CitizenNameT, CitizenTemplateNameT, ExternFunctionNameT, FullNameT, IVarNameT}
import dev.vale.{RangeS, vassert, vcurious, vfail, vpass, vwat}
import dev.vale.templar.types.{BoolT, BorrowT, CoordT, FloatT, ImmutableT, IntT, InterfaceTT, KindT, MutableT, NeverT, OwnT, OwnershipT, RuntimeSizedArrayTT, ShareT, StaticSizedArrayTT, StrT, StructTT, VariabilityT, VoidT, WeakT}
import dev.vale._
