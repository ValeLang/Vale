...
powershell -c "$ProgressPreference = 'SilentlyContinue' ; Invoke-WebRequest -Uri 'https://github.com/ValeLang/Vale/releases/download/v0.2.0/Vale-Windows-0.2.0.12.zip' -OutFile '%temp%\BootstrappingValeCompiler.zip'"
mkdir %2
