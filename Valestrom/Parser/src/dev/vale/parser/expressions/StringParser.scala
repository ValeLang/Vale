package dev.vale.parser.expressions

import dev.vale.parser.{BadStringChar, BadStringInterpolationEnd, BadUnicodeChar, ExpressionParser, IParseError, ParsingIterator, StopBeforeCloseBrace}
import dev.vale.Err
import dev.vale.parser.ast
import dev.vale.parser.ast.StrInterpolatePE
import StringParser.{StringPart, StringPartChar, StringPartExpr, parseFourDigitHexNum}
import dev.vale.{Err, Ok, Result}
import dev.vale.parser.ast.{ConstantStrPE, IExpressionPE, RangeP, StrInterpolatePE}
