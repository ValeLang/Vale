...
python3.8 ../valec.py ../vstl/arrayutils.vale ../vstl/list.vale ../vstl/opt.vale ../vstl/hashmap.vale ../vstl/hashset.vale ../vstl/utils.vale ../vstl/printutils.vale ../vstl/castutils.vale src/*.vale --gen-heap --region-override resilient-v3
mv ./a.out resilientv3
python3.8 ../valec.py ../vstl/arrayutils.vale ../vstl/list.vale ../vstl/opt.vale ../vstl/hashmap.vale ../vstl/hashset.vale ../vstl/utils.vale ../vstl/printutils.vale ../vstl/castutils.vale src/*.vale --gen-heap --region-override resilient-limit
mv ./a.out resilientlimit
...
echo "resilient-v3: $(/usr/bin/time -f "%e" ./resilientv3 2>&1)"
