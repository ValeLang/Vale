...
echo Running Tester...
build\tester --valestrom_path .\BuiltValeCompiler\Valestrom.jar --midas_path .\BuiltValeCompiler\midas --builtins_dir .\BuiltValeCompiler\builtins --valec_path .\BuiltValeCompiler\valec --midas_tests_dir ..\Midas\test --valestrom_tests_dir ..\Valestrom --concurrent 6 @assist || echo "Tests failed, aborting." && exit /b 1
