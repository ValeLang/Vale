package dev.vale.scout.patterns

import dev.vale.Interner
import dev.vale.parser.ast.{AbstractP, ConstructingMemberNameDeclarationP, DestructureP, IgnoredLocalNameDeclarationP, IterableNameDeclarationP, IterationOptionNameDeclarationP, IteratorNameDeclarationP, LocalNameDeclarationP, NameP, PatternPP}
import dev.vale.scout.{CantUseThatLocalName, CodeVarNameS, CompileErrorExceptionS, ConstructingMemberNameS, CoordTemplataType, IRuneS, ITemplataType, IterableNameS, IterationOptionNameS, IteratorNameS, LocationInDenizenBuilder, Scout, StackFrame, VariableDeclaration}
import dev.vale.scout.rules.{IRulexSR, TemplexScout}
