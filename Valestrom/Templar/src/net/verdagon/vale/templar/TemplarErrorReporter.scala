...
case class CouldntReconcileIfBranches(range: RangeS, thenResultType: Coord, elseResultType: Coord) extends ICompileErrorT
...
case class CantExtendStruct(range: RangeS, struct: StructRef2) extends ICompileErrorT
