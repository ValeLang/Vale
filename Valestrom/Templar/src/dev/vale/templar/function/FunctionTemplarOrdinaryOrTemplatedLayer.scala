...
import dev.vale.templar.env.{BuildingFunctionEnvironmentWithClosureds, BuildingFunctionEnvironmentWithClosuredsAndTemplateArgs, TemplataEnvEntry, TemplataLookupContext}
import dev.vale.templar.{ConvertHelper, InferTemplar, InitialKnown, InitialSend, TemplarOptions, TemplataTemplar, Temputs}
import dev.vale.templar.names.{BuildingFunctionNameWithClosuredsAndTemplateArgsT, FullNameT, NameTranslator, RuneNameT}
import dev.vale.templar.templata.{CoordTemplata, ITemplata}
import dev.vale.templar.types.ParamFilter
import dev.vale.templar.names.BuildingFunctionNameWithClosuredsAndTemplateArgsT
import dev.vale.{Err, Interner, Ok, Profiler, RangeS, vcurious, vimpl}
//import dev.vale.templar.infer.{InferSolveFailure, InferSolveSuccess}
