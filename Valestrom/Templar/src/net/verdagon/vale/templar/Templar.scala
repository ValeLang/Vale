...
trait IFunctionGenerator {
  def generate(
    // TODO: See if we can get rid of this, we might be able to separate out into a helper from FunctionTemplarCore
    functionTemplarCore: FunctionTemplarCore,
    structTemplar: StructTemplar,
    // TODO: See if we can get rid of this, perhaps by getting rid of autogenerated destructors, or making a helper
