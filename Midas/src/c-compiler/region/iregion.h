...
// This is to give to string operations and memcpy, but not sure about this, should we get rid of
// this?
struct BytesPtrLE { const LLVMValueRef llvmRef; };

class IRegion {
public:
  virtual ~IRegion() = default;

  virtual OwningRefLE allocate(
