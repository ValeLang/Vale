...
curl -L https://github.com/llvm/llvm-project/releases/download/llvmorg-13.0.0/clang+llvm-13.0.0-x86_64-linux-gnu-ubuntu-20.10.tar.xz --output /tmp/clang+llvm-13.0.0-x86_64-linux-gnu-ubuntu-20.10.tar.xz
mkdir -p $LLVM_DIR
tar xf /tmp/clang+llvm-13.0.0-x86_64-linux-gnu-ubuntu-20.10.tar.xz -C $LLVM_DIR
