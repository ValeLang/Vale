...
import dev.vale.{CodeLocationS, FileCoordinate, PackageCoordinate, metal, vwat}
import dev.vale.metal.FullNameH
import dev.vale.templar.Hinputs
import dev.vale.templar.names.{AnonymousSubstructConstructorNameT, AnonymousSubstructImplNameT, AnonymousSubstructMemberNameT, AnonymousSubstructNameT, BuildingFunctionNameWithClosuredsAndTemplateArgsT, BuildingFunctionNameWithClosuredsT, CitizenNameT, CitizenTemplateNameT, ClosureParamNameT, CodeVarNameT, ConstructingMemberNameT, ConstructorNameT, ConstructorTemplateNameT, ExternFunctionNameT, ForwarderFunctionNameT, ForwarderFunctionTemplateNameT, FreeNameT, FullNameT, FunctionNameT, FunctionTemplateNameT, INameT, ImplDeclareNameT, IterableNameT, IterationOptionNameT, IteratorNameT, LambdaCitizenNameT, LambdaTemplateNameT, LetNameT, MagicParamNameT, PackageTopLevelNameT, PrimitiveNameT, RawArrayNameT, RuntimeSizedArrayNameT, SelfNameT, StaticSizedArrayNameT, TemplarBlockResultVarNameT, TemplarFunctionResultVarNameT, TemplarPatternDestructureeNameT, TemplarPatternMemberNameT, TemplarTemporaryVarNameT, UnnamedLocalNameT}
import dev.vale.metal._
import dev.vale.scout.AnonymousSubstructParentInterfaceTemplateRuneS
...
//      case OverrideVirtualDropFunctionNameT(_, _, _) => "vdrop"
  ...
  def translateFullName(
    ...
    metal.FullNameH(readableName, id, packageCoord, newNameParts)
  }
