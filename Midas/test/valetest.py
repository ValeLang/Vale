...
class ValeTest(unittest.TestCase):
    ...
    def test_resilientv4_knownsizeimmarray(self) -> None:
        self.compile_and_execute_and_expect_return_code([PATH_TO_SAMPLES + "programs/arrays/knownsizeimmarray.vale"], "resilient-v4", 42)
