...
case class BadImpl(pos: Int, cause: CombinatorParseError) extends IParseError { override def errorId: String = "P1029"; override def equals(obj: Any): Boolean = vcurious(); override def hashCode(): Int = vcurious() }
...
case class BadImport(pos: Int, cause: CombinatorParseError) extends IParseError { override def errorId: String = "P1031"; override def equals(obj: Any): Boolean = vcurious(); override def hashCode(): Int = vcurious() }
