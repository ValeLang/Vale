...
clang ../Midas/src/builtins/*.c build/*.o build/abi/__vale/*.c build/abi/stdlib/*.c ../stdlib/src/path/native/*.c ../stdlib/src/command/native/*.c ../stdlib/src/os/native/*.c -Ibuild/include -o build/valec || { echo 'Clang build failed' ; exit 1; }
