package dev.vale.parser.templex

import dev.vale.{Err, Ok, Profiler, Result, vimpl, vwat}
import dev.vale.parser.expressions.StringParser
import dev.vale.parser.{BadArraySizerEnd, BadPrototypeName, BadPrototypeParams, BadRegionName, BadRuleCallParam, BadStringChar, BadTemplateCallParam, BadTypeExpression, BadUnicodeChar, IParseError, Parser, ParsingIterator, StopBeforeCloseSquare, StopBeforeComma, ast}
import dev.vale.parser.Parser.{ParsedDouble, ParsedInteger, parseRuneType, parseTypeName}
