...
case class StaticSizedArrayT2(size: Int, array: RawArrayT2) extends Kind {
  override def order: Int = 12;

  def name: FullName2[StaticSizedArrayName2] = FullName2(PackageCoordinate.BUILTIN, List(), StaticSizedArrayName2(size, RawArrayName2(array.mutability, array.memberType)))
...
case class RuntimeSizedArrayT2(array: RawArrayT2) extends Kind {
  override def order: Int = 19;

  def name: FullName2[RuntimeSizedArrayName2] = FullName2(PackageCoordinate.BUILTIN, List(), RuntimeSizedArrayName2(RawArrayName2(array.mutability, array.memberType)))
