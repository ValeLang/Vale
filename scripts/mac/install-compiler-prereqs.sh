...
curl -L https://github.com/ValeLang/Vale/releases/download/v0.2.0/Vale-Mac-0.2.0.11.zip --output /tmp/BootstrappingValec.zip
unzip /tmp/BootstrappingValec.zip -d $BOOTSTRAPPING_VALEC_DIR

# Install misc dependencies
echo "Downloading and unzipping depdendencies and LLVM..."
brew install llvm@13 sbt cmake coreutils
