...
import dev.vale.parser.ast.{AnonymousRunePT, ComponentsPR, CoordTypePR, EqualsPR, IRulexPR, KindTypePR, MutabilityPT, MutableP, NameOrRunePT, NameP, OwnP, OwnershipPT, TemplexPR, TuplePT, TypedPR}
import dev.vale.parser.templex.TemplexParser
import dev.vale.parser._
import dev.vale.parser.ast.PatternPP
import dev.vale.Collector
