package dev.vale.parsing.expressions

import dev.vale.parsing.{BadStringChar, BadStringInterpolationEnd, BadUnicodeChar, ExpressionParser, IParseError, ParsingIterator, StopBeforeCloseBrace}
import dev.vale.Err
import dev.vale.parsing.ast
import dev.vale.parsing.ast.StrInterpolatePE
import StringParser.{StringPart, StringPartChar, StringPartExpr, parseFourDigitHexNum}
import dev.vale.{Err, Ok, Result}
import dev.vale.parsing.ast.{ConstantStrPE, IExpressionPE, RangeP, StrInterpolatePE}
