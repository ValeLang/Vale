#ifndef REGION_RESILIENTV4_RESILIENTV4_H_
#define REGION_RESILIENTV4_RESILIENTV4_H_
...
class ResilientV4 : public IRegion {
public:
  ResilientV4(GlobalState* globalState, RegionId* regionId);
  ~ResilientV4() override = default;
...
protected:
  ...
  Ref loadAndUntether(FunctionState* functionState, LLVMBuilderRef builder, Local* local, LLVMValueRef localAddr);
